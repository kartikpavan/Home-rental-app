...
const CreateListingPage = () => {
  ...
  const handleCategorySelection = (category: string) => {
    ...
    if (category === "All") {
      updatedCategories =
        selectedCategories.length === categories.length ? [] : categories.map((cat) => cat.label);
    } else {
              ...
              <div className="md:px-20 pt-10 space-y-5">
                ...
                <section>
                  ...
                  {errors.streetAddress && (
                    <span className="text-xs text-red-500">{errors.streetAddress.message}</span>
                  )}
                </section>
                <section className="flex flex-col md:flex-row md:gap-10">
                  <div className="flex-1">
                    ...
                    {errors.apartmentSuite && (
                      <span className="text-xs text-red-500">{errors.apartmentSuite.message}</span>
                    )}
                  </div>
                  <div className="flex-1">
